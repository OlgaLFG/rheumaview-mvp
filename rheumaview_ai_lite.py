...
# --- PAGE CONFIG ---
st.set_page_config(page_title="RheumaView AI Lite (Fixed Autofill)", layout="wide")
...
name = st.text_input("Patient Name:", value="Name Unknown")
mrn = st.text_input("Medical Record Number:", value="123345")
dob_input = st.text_input("Date of Birth (YYYY-MM-DD):", value="2000-01-01")
clinical_context = st.text_area("Clinical context:", value="2 mo history of low back pain, worse last 4 days", height=100)
...
# --- Input collectors ---
si_level = dish_level = None
joint_space = erosions = density = periosteal = soft_tissue = osteophytes = other = impression = ""
...
Impression: {impression}\n"""
    ...
    doc.add_paragraph("\nMy Footer")
    filename = "rheumaview_structured_autofilled_FINAL.docx"
    doc.save(filename)
